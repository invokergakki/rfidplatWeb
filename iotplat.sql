...
Source Database       : iotplat

Target Server Type    : MYSQL
Target Server Version : 50644
File Encoding         : 65001

Date: 2020-02-10 15:33:14
*/
...
CREATE TABLE `assets_info` (
  `assets_id` varchar(96) NOT NULL DEFAULT '',
  `assets_name` varchar(192) DEFAULT NULL,
  `assets_type` varchar(48) DEFAULT NULL,
  `assets_use` varchar(192) DEFAULT NULL,
  `department` varchar(96) DEFAULT NULL,
  `user_name` varchar(96) DEFAULT NULL,
  `field1` varchar(96) DEFAULT NULL,
  `field2` varchar(96) DEFAULT NULL,
  `field3` varchar(96) DEFAULT NULL,
  `field4` varchar(96) DEFAULT NULL,
  `field5` varchar(96) DEFAULT NULL,
...
CREATE TABLE `assets_tags_info` (
  `assets_id` varchar(96) NOT NULL DEFAULT '',
  `epc_id` varchar(96) DEFAULT NULL,
  `assets_number` varchar(48) DEFAULT NULL,
  `scan_date` datetime DEFAULT NULL,
  `scan_place` varchar(384) DEFAULT NULL,
  `dev_name` varchar(96) DEFAULT NULL,
  `status` varchar(96) DEFAULT NULL,
  `opreate` varchar(96) DEFAULT NULL,
  `field3` varchar(96) DEFAULT NULL,
  `field4` varchar(96) DEFAULT NULL,
  `field5` varchar(96) DEFAULT NULL,
...
INSERT INTO `assets_tags_info` VALUES ('BOCSFMD20190711', '4D4400000000000020190711', '8', '2019-08-06 09:43:44', '一期1F138', '扫码枪C72', null, null, null, null, null);
INSERT INTO `assets_tags_info` VALUES ('BOCSFMD20190712', '4D4400000000000020190712', '8', '2019-08-06 09:43:44', '一期1F138', '扫码枪C72', null, null, null, null, null);
INSERT INTO `assets_tags_info` VALUES ('BOCSFMD20190714', '4D4400000000000020190714', '8', '2019-08-06 09:43:44', '一期1F138', '扫码枪C72', null, null, null, null, null);
